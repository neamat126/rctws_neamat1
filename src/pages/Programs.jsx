...
export default function Programs() {
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", backgroundColor: "#f4f6fa", direction: "rtl" }}>
      <Sidebar empname={empname} levelname={levelname} programs={programs} onLogout={handleLogout} />

      <div style={{ flex: 1, marginRight: sidebarW, padding: mobile ? "56px 16px 32px" : "28px 32px", fontFamily: "'Segoe UI', Tahoma, Arial, sans-serif" }}>
        {/* Header */}
        <div style={s.header}>
...
const s = {
  ...
  card:       { backgroundColor: "#fff", borderRadius: "12px", overflow: "hidden", border: "1px solid #E8ECF2", boxShadow: "0 2px 8px rgba(0,0,0,0.06)" },
