...
const s = {
  ...
  headerBar: { height: 3, background: "linear-gradient(90deg, #1B4F7A 0%, #2468A0 60%, #C9A84C 100%)" },
  ...
  mobileRing2: { position: "absolute", width: 100, height: 100, borderRadius: "50%", border: "1.5px solid rgba(201,168,76,.5)", animation: "spinRingRS 28s linear infinite" },
  mobileBorder: { width: 66, height: 66, borderRadius: "50%", padding: 3, background: "linear-gradient(135deg, #C9A84C 0%, #fff 50%, #C9A84C 100%)", position: "relative", zIndex: 1, flexShrink: 0 },
  ...
  leftContent: { position: "relative", zIndex: 1, display: "flex", flexDirection: "column", alignItems: "flex-end", gap: ".75rem" },
  illustWrap: { position: "relative", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: ".25rem", animation: "fadeUp .6s .3s both" },
  illustRing1: { position: "absolute", width: 240, height: 240, borderRadius: "50%", border: "1.5px dashed rgba(255,255,255,.45)", animation: "spinRingS 20s linear infinite" },
  illustRing2: { position: "absolute", width: 275, height: 275, borderRadius: "50%", border: "1.5px solid rgba(201,168,76,.5)", animation: "spinRingRS 28s linear infinite" },
  illustBorder: { width: 200, height: 200, borderRadius: "50%", padding: 4, background: "linear-gradient(135deg, #C9A84C 0%, #fff 50%, #C9A84C 100%)", animation: "glowPulseS 3s ease-in-out infinite", position: "relative", zIndex: 1, flexShrink: 0 },
  illustImg: { width: "100%", height: "100%", borderRadius: "50%", objectFit: "cover", display: "block" },
  illustBadge: { position: "absolute", bottom: 8, left: "calc(50% + 58px)", width: 26, height: 26, borderRadius: "50%", background: "#27ae60", border: "2px solid #1a3f6a", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 2, boxShadow: "0 2px 6px rgba(39,174,96,.5)" },
  panelTitle: { fontSize: 20, fontWeight: 600, color: "#fff", textAlign: "right", margin: 0, lineHeight: 1.5 },
  panelSub: { fontSize: 12, color: "rgba(255,255,255,.5)", letterSpacing: ".5px", margin: 0 },
  dividerLine: { width: "100%", height: 1, background: "rgba(255,255,255,.15)" },
  panelDesc: { fontSize: 12, color: "rgba(255,255,255,.55)", lineHeight: 1.8, textAlign: "right", margin: 0 },
  featureList: { display: "flex", flexDirection: "column", gap: 8, alignSelf: "stretch" },
  featureItem: { display: "flex", alignItems: "center", gap: 8, justifyContent: "flex-end", fontSize: 12, color: "rgba(255,255,255,.75)" },
  featureDot: { width: 5, height: 5, borderRadius: "50%", background: "#C9A84C", flexShrink: 0 },

  /* Card */
  rightPanel: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "1.5rem 2.5rem" },
  card: { width: "100%", maxWidth: 400, background: "#fff", borderRadius: 16, border: "1px solid #DDE1E7", boxShadow: "0 4px 24px rgba(27,79,122,.08)", overflow: "hidden" },
  cardHeader: { background: "#EBF3FA", padding: "1.25rem 2rem 1rem", textAlign: "center", borderBottom: "1px solid #DDE1E7" },
  ...
  submitBtn: { width: "100%", padding: "11px", background: "#1B4F7A", color: "#fff", border: "none", borderRadius: 9, fontSize: 14, fontWeight: 600, cursor: "pointer", fontFamily: "inherit", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, transition: ".2s", marginBottom: ".75rem" },
